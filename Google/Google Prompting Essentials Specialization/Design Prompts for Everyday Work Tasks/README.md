...
### 🏫 Google: Design Prompts for Everyday Work Tasks

Applies prompting techniques to recurring workplace tasks and structured outputs.

Official course information: [Coursera course page](https://www.coursera.org/learn/google-design-prompts-for-everyday-work-tasks).
...
| Module | Topics |
| :--- | :--- |
| [Module 1: Design prompts for everyday work tasks](./Module%201%20-%20Design%20prompts%20for%20everyday%20work%20tasks.md) | Task decomposition; prompt structure; useful workplace outputs |
