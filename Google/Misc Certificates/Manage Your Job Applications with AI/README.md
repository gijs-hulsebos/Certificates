...
This course is part of **Google Career Certificates - AI Job Search Courses** and develops practical knowledge for responsible, effective AI-enabled work.

---

### 📚 Course Focus

Using AI to organize, prioritize, and improve the job application process.
