...
### 🏫 Google Cloud: Gemini in Google Docs

Applies Gemini to drafting, revising, and organizing documents in Google Docs.

Official course information: [Coursera course page](https://www.coursera.org/learn/duet-ai-in-google-docs).
...
| Module | Topics |
| :--- | :--- |
| [Module 1: Gemini in Google Docs](./Module%201%20-%20Gemini%20in%20Google%20Docs.md) | Core Gemini in Google Docs workflows; AI-assisted productivity; review and refinement |
...
👉 **[View Course Certificate](./Google%20Cloud%20Gemini%20in%20Google%20Docs%20Coursera%20ZKRGIO4T70KX.pdf)**
---
