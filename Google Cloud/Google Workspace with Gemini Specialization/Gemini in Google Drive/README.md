...
### 🏫 Google Cloud: Gemini in Google Drive

Uses Gemini to locate, summarize, and work with information stored in Google Drive.

Official course information: [Coursera course page](https://www.coursera.org/learn/gemini-in-google-drive).
...
| Module | Topics |
| :--- | :--- |
| [Module 1: Gemini in Google Drive](./Module%201%20-%20Gemini%20in%20Google%20Drive.md) | Core Gemini in Google Drive workflows; AI-assisted productivity; review and refinement |
