...
### 🏫 Google Cloud: Create Engaging Video with Google Vids

Introduces planning, creating, and refining workplace videos with Google Vids.

Official course information: [Coursera course page](https://www.coursera.org/learn/create-engaging-video-with-google-vids).
...
| Module | Topics |
| :--- | :--- |
| [Module 1: Create Engaging Video with Google Vids](./Module%201%20-%20Create%20Engaging%20Video%20with%20Google%20Vids.md) | Core Create Engaging Video with Google Vids workflows; AI-assisted productivity; review and refinement |
